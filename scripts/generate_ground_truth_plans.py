...
def main():
    ...
    parser.add_argument("--output-path", type=Path, default=Path("derived/rime/ground_truth/permissible_plans.jsonl"), help="Output JSONL path for symbolic permissible plans. Default: %(default)s")
