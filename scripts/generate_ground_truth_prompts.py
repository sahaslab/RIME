...
DEFAULT_PLAN_PATH = Path("~/lab/postmaster/ground_truth/postmaster/ground_truth/retagged_subsample.jsonl")
DEFAULT_OUTPUT_PATH = Path("~/lab/postmaster/ground_truth/postmaster/ground_truth/retagged_subsample_prompts.jsonl")
MAX_ROUNDS = 3
